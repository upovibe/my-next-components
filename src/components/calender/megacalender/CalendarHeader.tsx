      ...
      <div className="flex items-center gap-2">
        {showSwitchHourFormat && (
          <SwitchButton
            ...
            textTrue="12-hour"
            textFalse="24-hour"
            className="flex items-center rounded-full whitespace-nowrap justify-center font-semibold text-soft dark:text-pale hover:bg-tertiary dark:hover:bg-shadow transition-all duration-200 ease-linear cursor-pointer"
            showTextOnly
          />
        )}
        {showTodayButton && (
